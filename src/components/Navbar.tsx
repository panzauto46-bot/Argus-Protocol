...
export default function Navbar() {
  ...
  const { page, setPage, walletConnected, setWalletConnected, walletAddress, contractStatus } = useApp();
  ...
  const navItems: { id: 'dashboard' | 'config' | 'notifications' | 'recovery'; label: string; icon: React.ReactNode }[] = [
          ...
          <div className="flex items-center gap-3">
            ...
            {walletConnected ? (
              <div className="flex items-center gap-2">
                ...
                <button
                  onClick={() => { setWalletConnected(false); setPage('landing'); }}
              ...
              <button
                ...
                className="px-4 py-2 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-lg text-sm font-semibold hover:from-cyan-400 hover:to-blue-400 transition-all shadow-lg shadow-cyan-500/25"
              >
                Connect Wallet
              </button>
            )}
