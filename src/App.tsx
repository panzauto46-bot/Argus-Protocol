...
interface AppContextType {
  ...
  contractStatus: 'safe' | 'monitoring' | 'triggered';
  setContractStatus: (s: 'safe' | 'monitoring' | 'triggered') => void;
}
...
export default function App() {
  ...
  const [walletAddress] = useState('0x7a3F...9E2d');
  const [contractStatus, setContractStatus] = useState<'safe' | 'monitoring' | 'triggered'>('safe');
